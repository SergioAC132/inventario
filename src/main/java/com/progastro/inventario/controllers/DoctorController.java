...
public class DoctorController {
    ...
    private final DoctorServiceBridge doctorServiceBridge;

    @PostMapping("/registrar-doctor")
    public ResponseEntity<ApiResponse<DoctorResponseDTO>> registrarDoctor(@RequestBody @Valid DoctorRequestDTO request) {
        DoctorResponseDTO response = doctorServiceBridge.registrarDoctor(request);
    ...
    public ResponseEntity<PageResponse<DoctorResponseDTO>> listarDoctores(
        ...
        Page<DoctorResponseDTO> result = doctorServiceBridge.listarDoctores(nombre, page, size);
